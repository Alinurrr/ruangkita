...
<div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><i class="fa fa-dashboard"></i>Kategori</li>
          </ol>
        </section>
    <!-- Main content -->
         ...
         <div class="col-md-12">
            <div class="box box-info">
                ...
                <div class="box-footer clearfix">
                  <a href="<?php echo $base_url; ?>admin/adminweb.php?module=tambah_kategori" class="btn btn-sm btn-info btn-flat pull-left">Tambah Kategori</a>
