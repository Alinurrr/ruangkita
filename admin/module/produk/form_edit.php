                ...
                <form class="form-horizontal" action="../admin/module/produk/aksi_edit.php" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        ...
                        while ($idKategori=mysqli_fetch_array($kueriKategori)) {
                          ...
                          if ($id_kategori==$idKategori['id_kategori']) {
                            $select="selected";
                          }else {
                              $select="";
                          }
                        ...
                        ?>
                        <option value="<?php echo $idKategori['id_kategori'];?>" <?= $select;  ?>><?php echo $idKategori['nama_kategori'];?></option><?php } ?>
                        </select>
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <select class="form-control" name="idMerek">
                          ...
                          while ($idMerek=mysqli_fetch_array($kueriMerek)) {
                            if ($id_merek==$idMerek['id_merek']) {
                              $select="selected";
                            }else {
                                $select="";
                            }
                          ?>
                          <option value="<?php echo $idMerek['id_merek'];?>" <?= $select;  ?>><?php echo $idMerek['nama_merek'];?></option><?php } ?>
                     ...
                     <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" id="namaProduk" name="nama_produk" placeholder="Nama Produk" value="<?= $namaProduk;?>">
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="gambar" class="col-sm-2 control-label">Gambar</label>
                      <div class="col-sm-10">
                      <img src="../admin/upload/<?= $gambar;  ?>" class="img img-fluid mb-1" height="100">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" id="deskripsiProduk" name="deskripsi" placeholder="Deskripsi Produk" value="<?= $deskripsiProduk;?>">
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="hargaProduk" class="col-sm-2 control-label">Harga Produk</label>
                      <div class="col-sm-10">
                        <input type="text" class="form-control" id="hargaProduk" name="harga" placeholder="Harga Produk" value="<?= $hargaProduk;?>">
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <div class="radio">
                          <label>
                        <input type="radio" name="slide" id="slide" value="Y" <?php if($slide =='Y') echo 'checked'?>>Ya
                      </label>
                      </div>
                      <div class="radio">
                          <label>
                        <input type="radio" name="slide" id="slide" value="N" <?php if($slide =='N') echo 'checked'?>>Tidak
                      </label>
                      </div>
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <div class="radio">
                          <label>
                        <input type="radio" name="rekomendasi" id="rekomendasi" value="Y" <?php if($rekomendasi =='Y') echo 'checked'?>>Ya
                      </label>
                      </div>
                      <div class="radio">
                          <label>
                        <input type="radio" name="rekomendasi" id="rekomendasi" value="N" <?php if($rekomendasi =='N') echo 'checked'?>>Tidak
                      </label>
                      </div>
                      </div>
                    </div> 
