      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="adminfounder.php?module=list_pemesanan">
                <i class="menu-icon typcn typcn-document-text"></i>
            ...
            <li class="nav-item">
              <a class="nav-link" href="adminfounder.php?module=list_bank">
                <i class="menu-icon typcn typcn-shopping-bag"></i>
                <span class="menu-title">Jenis Pembayaran</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="adminfounder.php?module=list_konfirmasi">
         ...
         <?php
            ...
            if ($_GET['module'] == 'list_ruangan'){
              include "module/data_ruangan/list_ruangan.php";
            }


             elseif ($_GET['module'] == 'list_bank'){
              include "module/data_bank/list_bank.php";
            } elseif ($_GET['module'] == 'tambah_bank'){
              include "module/data_bank/tambah_bank.php";
            }

             elseif ($_GET['module'] == 'list_pemesanan'){
              include "module/pesanan_founder/list_pemesanan.php";
            }
            elseif ($_GET['module'] == 'list_konfirmasi'){
              include "module/data_konfirmasi/list_konfirmasi.php";
            }
