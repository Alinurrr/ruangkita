...
?>
  ...
  <body>
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="adminfounder.php?module=home">
   ...
   -->
        ...
        if ($_GET['module'] == 'home') {
          include "module_founder/home/home.php";
        }
        ...
        elseif ($_GET['module'] == 'list_ruangan') {
          ...
          include "module_founder/data_ruangan/form_edit.php";
        }
        // module aktivitas
        elseif ($_GET['module'] == 'list_pesanan') {
          include "module_founder/data_pesanan/list_pesanan.php";
        } elseif ($_GET['module'] == 'tambah_pesanan') {
          include "module_founder/data_pesanan/tambah_pesanan.php";
        } elseif ($_GET['module'] == 'edit_pesanan') {
          include "module_founder/data_pesanan/form_edit.php";
        }
