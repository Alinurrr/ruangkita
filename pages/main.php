							...
							while ($r = mysqli_fetch_array($q)) { ?>
								<div class="panel panel-default">
									<div class="panel-heading">
										<h4 class="panel-title"><a href="#"><?= $r['nama_kategori'];  ?></a></h4>
									</div>
								</div>
							<?php } ?>
						</div>
						...
						<div class="brands_products">
							...
							<div class="brands-name">
								<ul class="nav nav-pills nav-stacked">
									...
									while ($r = mysqli_fetch_array($q)) { ?>
										<li><a href="#"> <span class="pull-right">(50)</span><?= $r['nama_merek'];  ?></a></li>
									<?php } ?>
								</ul>
							</div>
						</div>
								...
								<div class="product-image-wrapper">
									<div class="single-products">
										<div class="productinfo text-center">
											<img src="admin/upload/<?= $r['gambar'];  ?>" alt="" />
											<h2>Rp.<?= number_format($r['harga']);  ?></h2>
											<p><?= $r['nama_produk'];  ?></p>
											<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
										</div>
										<div class="product-overlay">
											<div class="overlay-content">
												<h2>Rp.<?= number_format($r['harga']);  ?>6</h2>
												<p><?= $r['nama_produk'];  ?></p>
												<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
											</div>
										</div>
